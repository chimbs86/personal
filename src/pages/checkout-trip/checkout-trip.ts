...
export class CheckoutTripPage {
  ...
  constructor(public nav: NavController, public tripService: AbstractInformationService, public loadingCtrl: LoadingController, public toastCtrl: ToastController) {
    // set sample data
